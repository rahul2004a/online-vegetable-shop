...
const Fruits = () => {
  return (
    ...
    <div><h2>POPULAR FRUITS</h2></div>
    <div className="card-item" style={{padding:"2rem"}}>
    <Card name="Lady Finger" price="15.6" source={v1}/>
        <Card name="Lady Finger" price="13.6" source={v2}/>
        <Card name="Lady Finger" price="11.6" source={v3}/>
        <Card name="Lady Finger" price="17.6" source={v4}/>
        <Card name="Lady Finger" price="20.6" source={v5}/>
        <Card name="Lady Finger" price="13.6" source={v6}/>
        <Card name="Lady Finger" price="70.6" source={v7}/>
        <Card name="Lady Finger" price="80.6" source={v8}/>
        <Card name="Lady Finger" price="38.6" source={v9}/>
        <Card name="Lady Finger" price="77.6" source={v10}/>
        ...
        <Card name="Lady Finger" price="78.6" source={v15}/>
    </div>
    </div>
  )
}
